...
**Base path:** `/api/v1/`
_(These use standard RESTful routing. Examples below are for `GET`, but standard `POST`, `PUT`, `PATCH`, and `DELETE` methods are generally supported based on permissions)_
