      ...
      <div className="hidden lg:flex lg:w-1/2 bg-linear-to-br from-primary-600 via-primary-500 to-secondary-600 dark:from-primary-700 dark:via-primary-600 dark:to-secondary-700 flex-col justify-between p-12 text-white relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-[0.07]">
          <svg className="w-full h-full" viewBox="0 0 600 800" xmlns="http://www.w3.org/2000/svg">
            ...
            <line x1="100" y1="150" x2="200" y2="100" stroke="white" strokeWidth="1.5"/>
            <line x1="200" y1="100" x2="300" y2="200" stroke="white" strokeWidth="1.5"/>
            <line x1="300" y1="200" x2="450" y2="120" stroke="white" strokeWidth="1.5"/>
            <line x1="450" y1="120" x2="500" y2="300" stroke="white" strokeWidth="1.5"/>
            <line x1="100" y1="150" x2="150" y2="400" stroke="white" strokeWidth="1.5"/>
            <line x1="300" y1="200" x2="500" y2="300" stroke="white" strokeWidth="1.5"/>
            <line x1="150" y1="400" x2="350" y2="500" stroke="white" strokeWidth="1.5"/>
            <line x1="350" y1="500" x2="480" y2="550" stroke="white" strokeWidth="1.5"/>
            <line x1="80" y1="650" x2="250" y2="700" stroke="white" strokeWidth="1.5"/>
            <line x1="250" y1="700" x2="420" y2="680" stroke="white" strokeWidth="1.5"/>
            <line x1="480" y1="550" x2="420" y2="680" stroke="white" strokeWidth="1.5"/>
          </svg>
        </div>
